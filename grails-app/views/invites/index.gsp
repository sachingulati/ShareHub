...
<body>
<a href="#list-invites" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="dateCreated"
                              title="${message(code: 'invites.dateCreated.label', default: 'Date Created')}"/>
            ...
            <g:sortableColumn property="lastUpdated"
                              title="${message(code: 'invites.lastUpdated.label', default: 'Last Updated')}"/>
        ...
        <g:each in="${invitesInstanceList}" status="i" var="invitesInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${invitesInstance.id}">${fieldValue(bean: invitesInstance, field: "dateCreated")}</g:link></td>
