...
<div id="show-topic" class="content scaffold-show" role="main">
    ...
    <ol class="property-list topic">
        ...
        <g:if test="${topicInstance?.createdBy}">
            <li class="fieldcontain">
                <span id="createdBy-label" class="property-label"><g:message code="topic.createdBy.label"
                                                                             default="Created By"/></span>

                <span class="property-value" aria-labelledby="createdBy-label"><g:link controller="user" action="show"
                                                                                       id="${topicInstance?.createdBy?.id}">${topicInstance?.createdBy?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${topicInstance?.resources}">
            <li class="fieldcontain">
                <span id="resources-label" class="property-label"><g:message code="topic.resources.label"
        ...
        <g:if test="${topicInstance?.subscriptions}">
            <li class="fieldcontain">
                <span id="subscriptions-label" class="property-label"><g:message code="topic.subscriptions.label"
