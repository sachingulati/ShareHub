...
<body>
<a href="#list-resourceStatus" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="score"
                              title="${message(code: 'resourceStatus.score.label', default: 'Score')}"/>

            <g:sortableColumn property="isRead"
                              title="${message(code: 'resourceStatus.isRead.label', default: 'Is Read')}"/>
        ...
        <g:each in="${resourceStatusInstanceList}" status="i" var="resourceStatusInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${resourceStatusInstance.id}">${fieldValue(bean: resourceStatusInstance, field: "score")}</g:link></td>
