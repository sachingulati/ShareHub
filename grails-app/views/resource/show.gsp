    ...
    <ol class="property-list resource">
        ...
        <g:if test="${resourceInstance?.description}">
            <li class="fieldcontain">
                <span id="description-label" class="property-label"><g:message code="resource.description.label"
                                                                               default="Description"/></span>

                <span class="property-value" aria-labelledby="description-label"><g:fieldValue
                        bean="${resourceInstance}" field="description"/></span>
        ...
        <g:if test="${resourceInstance?.createdBy}">
            <li class="fieldcontain">
                <span id="createdBy-label" class="property-label"><g:message code="resource.createdBy.label"
                                                                             default="Created By"/></span>

                <span class="property-value" aria-labelledby="createdBy-label"><g:link controller="user" action="show"
                                                                                       id="${resourceInstance?.createdBy?.id}">${resourceInstance?.createdBy?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${resourceInstance?.resourceStatus}">
            <li class="fieldcontain">
                <span id="resourceStatus-label" class="property-label"><g:message code="resource.resourceStatus.label"
                                                                                  default="Resource Status"/></span>

                <g:each in="${resourceInstance.resourceStatus}" var="r">
                    <span class="property-value" aria-labelledby="resourceStatus-label"><g:link
                            controller="resourceStatus" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></span>
                </g:each>
